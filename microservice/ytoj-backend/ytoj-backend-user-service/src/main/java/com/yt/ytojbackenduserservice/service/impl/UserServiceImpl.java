package com.yt.ytojbackenduserservice.service.impl;
...
import com.yt.ytojbackenduserservice.mapper.UserMapper;
...
import static com.yt.ytojbackendcommon.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            user.setUserAvatar("https://preview.pro.ant.design/logo.svg");
            user.setUserName("新注册用户");
