...
import com.yt.ytojbackendquestionservice.mapper.QuestionSubmitMapper;
import com.yt.ytojbackendquestionservice.rabbitmq.MyMessageProducer;
...
public class QuestionSubmitServiceImpl extends ServiceImpl<QuestionSubmitMapper, QuestionSubmit>
    ...
    public long doQuestionSubmit(QuestionSubmitAddRequest questionSubmitAddRequest, User loginUser) {
        ...
        myMessageProducer.sendMessage("judge_service_exchange", "judge_service_routingKey", String.valueOf(questionSubmitId));
//        judgeFeignClient.doJudge(questionSubmitId);
    ...
    public QuestionSubmitVO getQuestionSubmitVO(QuestionSubmit questionSubmit, User loginUser) {
        ...
        // 处理脱敏
        if (!id.equals(questionSubmit.getUserId()) && !userFeignClient.isAdmin(loginUser)) {
